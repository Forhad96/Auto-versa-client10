  ...
  return (
    <div className="relative w-full h-full flex flex-col justify-center items-center bg-base-100  dark:bg-gray-800  text-gray-800 dark:text-gray-200 overflow-hidden">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center items-center text-gray-600 dark:text-gray-200">
          ...
          <div className="p-5 flex flex-col justify-center items-center lg:items-start text-center lg:text-left">
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center">
              <button className="m-1.5 py-2.5 px-5 rounded-md bg-blue-500 text-white font-semibold uppercase hover:bg-blue-400">
                Start your journey
              </button>
              <button className="m-1.5 py-2.5 px-5 rounded-md border-2 border-gray-300 text-gray-400 dark:text-gray-200 font-semibold uppercase hover:text-blue-400 hover:border-blue-400">
                Take a test drive
              </button>
            </div>
          </div>
      ...
      <div className="container mt-14 p-5 w-full grid grid-cols-12 sm:grid-cols-5 gap-2 text-xs md:text-sm">
        {/* ::Auto-Magic Layouts */}
        <div className="col-span-4 sm:col-span-1 inline-flex flex-col items-center border-r border-gray-300 text-gray-400 dark:text-gray-200 uppercase">
          <svg
        ...
        {/* ::Fast Shipping */}
        <div className="col-span-6 sm:col-span-1 inline-flex flex-col items-center border-r border-gray-300 text-gray-400 dark:text-gray-200 uppercase">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-9 w-9"
            fill="none"
        ...
        {/* ::Layflat Page */}
        <div className="col-span-6 sm:col-span-1 inline-flex flex-col items-center border-r-none border-gray-300 text-gray-400 dark:text-gray-200 uppercase">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-9 w-9"
            fill="none"
