        ...
        <div className="p-4 mx-auto max-w-7xl">
          <div className="mb-20 text-center">
            ...
            <p className="max-w-xl mx-auto text-gray-500">
              Auto Versa is your dedicated automotive partner. We&lsquo;re here
              to make your car-buying experience seamless, provide top-notch
              maintenance services, and offer expert guidance. Your trust is our
              motivation, and we&lsquo;re committed to delivering excellence
              every step of the way. Thank you for choosing Auto Versa as your
              trusted automotive solution.
            </p>
          </div>
          <div className="flex ">
            <div className="grid grid-cols-1 gap-4 lg:gap-8 sm:gap-4 sm:grid-cols-2 lg:grid-cols-3">
              ...
              >
                <div className="z-20 pt-8 pb-5">
                  ...
                  <p className="mb-4 text-base leading-7 text-gray-400">
                    I chose Auto Versa for their top-notch maintenance services,
                    and I've never been disappointed. Their skilled team keeps
                    my vehicle in excellent condition, and their customer care
                    is second to none.
                  </p>
                  <h2 className="text-lg font-bold leading-9 text-black dark:text-white">
                    Watson Gems
              ...
              >
                <div className="z-20 pt-8 pb-5">
                  ...
                  <p className="mb-4 text-base leading-7 text-gray-400">
                    Auto Versa is my one-stop solution for all things
                    automotive. From helping me find my ideal car to regular
                    maintenance, they've been consistent in delivering quality
                    and reliability. I highly recommend them.
                  </p>
                  <h2 className="text-lg font-bold leading-9 text-black dark:text-white">
                    Stephan Kings
                  </h2>
