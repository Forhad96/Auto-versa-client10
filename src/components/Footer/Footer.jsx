    ...
    return (
      <section className="flex flex-col  lg:justify-end font-poppins">
        <div className="w-full bg-gray-800 dark:bg-gray-900 ">
            ...
            <div className="flex flex-wrap py-10 -mx-3">
              <div className="w-full px-4 mb-11 md:w-1/2 lg:w-4/12 lg:mb-0">
                ...
                <p className="text-base font-normal leading-6 text-gray-300 lg:w-64 dark:text-gray-400">
                  Auto Varsa: Your automotive destination. We&lsquo;re
                  passionate about cars and dedicated to delivering excellence.
                  Whether it&lsquo;s the latest models, quality used cars, or
                  expert maintenance, we&lsquo;re your trusted partner for
                  customer satisfaction and automotive excellence.
                </p>
          ...
          <div className="py-4 text-center text-gray-300 bg-blue-900 dark:bg-gray-800 dark:text-gray-400">
